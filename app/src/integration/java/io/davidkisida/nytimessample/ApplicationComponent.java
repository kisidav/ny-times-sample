...
import io.davidkisida.nytimessample.api.ApiModule;
...
@Singleton
@Component(modules = {AndroidInjectionModule.class, ActivityBuilderModule.class, ApiModule.class})
public interface ApplicationComponent extends BaseApplicationComponent {

    void inject(DefaultGlideModule glideModule);
